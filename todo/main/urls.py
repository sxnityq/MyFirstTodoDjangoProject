...
urlpatterns = [path('', view=Home.as_view(), name='home'),
               ...
               path('profile/view/<str:username>', view=ViewUserProfile.as_view(),
                    name='profile-view'),

               path('profile/edite/<str:username>', view=EditeUserProfile.as_view(),
                    name='profile-edite'),

               path('reset-password/', view=auth_views.PasswordResetView.as_view(),
                    name='reset_password'),
