...
class ToDoModels(models.Model):
    ...
    TaskId = models.AutoField(verbose_name='id', primary_key=True, db_column='id', db_index=True)
    User = models.ForeignKey(CustomUser, on_delete=models.CASCADE, related_name='users')
    TaskTitle = models.CharField(verbose_name='title', max_length=32, null=False, blank=False, unique=True)
    ...
    TimeOfCreation = models.DateTimeField(verbose_name='time_creation', auto_now_add=True)
